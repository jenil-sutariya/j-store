...
-- CreateEnum
CREATE TYPE "MetalType" AS ENUM ('GOLD', 'ROSE_GOLD', 'WHITE_GOLD', 'SILVER', 'PLATINUM');

-- CreateEnum
CREATE TYPE "Purity" AS ENUM ('K14', 'K18', 'K20', 'K22', 'K24', 'S925', 'PT950');

-- CreateEnum
CREATE TYPE "Gender" AS ENUM ('MEN', 'WOMEN', 'KIDS', 'UNISEX');

-- CreateEnum
CREATE TYPE "Occasion" AS ENUM ('BRIDAL', 'DAILY_WEAR', 'PARTY', 'FESTIVE', 'OFFICE', 'ENGAGEMENT', 'ANNIVERSARY', 'GIFTING');

-- CreateEnum
CREATE TYPE "Gemstone" AS ENUM ('DIAMOND', 'RUBY', 'EMERALD', 'SAPPHIRE', 'PEARL', 'CUBIC_ZIRCONIA', 'KUNDAN', 'POLKI', 'NONE');

-- CreateEnum
CREATE TYPE "StyleTag" AS ENUM ('STUD', 'HOOP', 'JHUMKA', 'DROP', 'CHANDBALI', 'SOLITAIRE', 'COCKTAIL', 'BAND', 'CHAIN', 'PENDANT_SET', 'BANGLE', 'CUFF');

-- CreateEnum
CREATE TYPE "AddressType" AS ENUM ('SHIPPING', 'BILLING');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING_PAYMENT', 'CONFIRMED', 'PROCESSING', 'PACKED', 'SHIPPED', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED', 'RETURN_REQUESTED', 'RETURNED', 'REFUNDED');
...
CREATE TABLE "Product" (
    ...
    "gstRate" DECIMAL(4,2) NOT NULL DEFAULT 3.00,
    "hsnCode" TEXT,
...
CREATE TABLE "OrderItem" (
    ...
    "gstRateSnapshot" DECIMAL(4,2) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductVariant_productId_metalType_purity_size_key" ON "ProductVariant"("productId", "metalType", "purity", "size");
